...
- [x] `tasks/phase-1.1-task-01.md` — Validación del query param `status` (incluye caso inválido → 400).
- [x] `tasks/phase-1.1-task-02.md` — Método `findFiltered` en `ProjectRepo` con status.
- [x] `tasks/phase-1.1-task-03.md` — Conectar controller → service → repo para status.

**Criterios de cierre de la fase:**
- [x] Todas las tareas marcan ✅.
- [x] AC-1, AC-2, AC-4 verificados.
- [x] `/gsd-verify-work` no reporta desviaciones.
...
**Tareas:**
- [x] `tasks/phase-1.2-task-01.md` — Validación de `from`/`to` (formato y rango).
- [x] `tasks/phase-1.2-task-02.md` — Extender `findFiltered` con rango de fechas.
- [x] `tasks/phase-1.2-task-03.md` — Tests de combinación AND (AC-6) y no-regresión (AC-7).

**Criterios de cierre:**
- [x] AC-3, AC-5, AC-6, AC-7 verificados.
- [x] Los 12 tests existentes siguen pasando.
...
**Tareas:**
- [x] `tasks/phase-1.3-task-01.md` — Ejecutar todas las verificaciones de AC-1..7.
- [x] `tasks/phase-1.3-task-02.md` — Revisar diff contra alcance de la spec (sección 7).
